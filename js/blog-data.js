...
const BLOG_POSTS = [
  {
    ...
    content: `
      ...
      <table>
        ...
        <tbody>
          <tr><td>⭐ Highest Sam Score</td><td>Superica, 8.1</td></tr>
  ...
  },
  {
    ...
    faq: [
      ...
      },
      {
        ...
        answer:
          "I've reviewed two so far. Dusty's Oyster Bar (8.1) is the one to beat if you want oysters and a proper local room, and Sharky's Beachfront Restaurant (7.9) is right on the Gulf if the view matters as much as the food. Mike's Cafe & Oyster Bar and Local Steamer Seafood Market are still on my radar.",
      },
      {
    ...
    content: `
      ...
      <p><strong>Neighborhood:</strong> Front Beach Road</p>
      <p><strong>Sam Score:</strong> 8.1/10</p>
      <p><strong>Best For:</strong> Oysters, fried seafood and a proper local room</p>
      ...
      <p>Dusty's is the old-school Florida oyster bar people keep telling you about, a loud room off Front Beach Road with dollar bills stapled across every inch of the ceiling. Their own slogan is "Home of warm beer, lousy food and ugly waitresses," so you know what you're walking into.</p>
      <p>I got the Dusty's Oyster Sampler and a half dozen seafood oysters, plus the world famous fried green tomatoes and frog legs. It's busy, and that's the one thing to plan around. <a href="/reviews/dustys-oyster-bar-panama-city-beach">Read Sam's full review →</a></p>
