...
const PLACES = [
  ...
  },
  {
    ...
    lat: 36.18083,
    lng: -86.77996,
    address: "2315 Bowline Ave, Nashville, TN 37207",
    phone: "(615) 442-5555",
    parking: "Free 2-hour parking",
    website: "https://thaisamurai.com/",
    date: "2026-09-11",
    price: "$$$",
    cuisine: "Thai",
    badges: ["worth-the-wait", "date-night"],
    about: "Thai Samurai serves Thai food and sushi, and this is their River North location on the East Bank. There's a tuk-tuk parked out front, and the bar sits under big backlit samurai murals. The Flaming Tiger Roll comes out wrapped in foil and gets set on fire at the table.",
    ate: "A Thai Spicy Margarita, the Volcanic Lobster, Drunken Noodles with chicken at level 3 hot, and the Flaming Tiger Roll.",
    heroPhoto: "images/reviews/thai-samurai-river-north-nashville/order-volcanic-lobster.jpg",
    photos: [
      { src: "images/reviews/thai-samurai-river-north-nashville/storefront.jpg", alt: "Thai Samurai River North entrance at night, with a neon sign and a tuk-tuk out front" },
      { src: "images/reviews/thai-samurai-river-north-nashville/interior.jpg", alt: "Dining room at Thai Samurai River North, Nashville" },
      { src: "images/reviews/thai-samurai-river-north-nashville/interior-bar.jpg", alt: "The bar at Thai Samurai River North under backlit samurai murals" },
      { src: "images/reviews/thai-samurai-river-north-nashville/drink-spicy-margarita.jpg", alt: "Sam's drink: the Thai Spicy Margarita with a dried chili and charred lime, Thai Samurai" },
      { src: "images/reviews/thai-samurai-river-north-nashville/order-volcanic-lobster.jpg", alt: "Sam's order: the Volcanic Lobster with a lobster tail and an orchid garnish, Thai Samurai" },
      { src: "images/reviews/thai-samurai-river-north-nashville/order-drunken-noodles.jpg", alt: "Sam's order: Drunken Noodles with chicken, level 3 hot, Thai Samurai" },
      { src: "images/reviews/thai-samurai-river-north-nashville/order-flaming-tiger-roll.jpg", alt: "Sam's order: the Flaming Tiger Roll served in foil, Thai Samurai" },
    ],
    // scores: { taste: 9, value: 8, atmosphere: 9, service: 7 }, // TODO: Sam — fill in your 0-10 breakdown and this section will appear automatically.
    pros: ["Cool area of town"],
    cons: ["Slow"],
    rating: 9.0,
    video: "https://www.instagram.com/reel/DdSNeOVR8-t/",
    tags: ["Thai", "River North"],
  },
  {
    id: "mcguires-irish-pub-panama-city-beach",
    name: "McGuire's Irish Pub",
    city: "Panama City Beach, FL",
    lat: 30.2265627,
    lng: -85.8956835,
    address: "17290 Front Beach Rd, Panama City Beach, FL 32413",
    phone: "(850) 588-1292",
    parking: "Free parking",
    website: "https://www.mcguiresirishpub.com/pcb",
    date: "2026-09-06",
    price: "$$$",
    cuisine: "Irish",
    badges: ["family-friendly", "group-friendly", "easy-parking"],
    about: "McGuire's is a 550-seat Irish pub and steakhouse on Front Beach Road, across from the Gulf. It's the third McGuire's, after Pensacola and Destin, and opened in 2025. Signed dollar bills cover the ceiling and every wall, they brew their own ales in house, and Irish musicians play late every night.",
    ate: "The McGuire's Root Beer, the 18\u00a2 Senate Bean Soup, Reuben Egg Rolls, a Filet Mignon, the Pasta Rustica, and the Garlic Mashed Potatoes.",
    heroPhoto: "images/reviews/mcguires-irish-pub-panama-city-beach/order-filet-mignon.jpg",
    photos: [
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/storefront.jpg", alt: "McGuire's Irish Pub entrance and parking lot, with Irish flags along the roofline, Panama City Beach" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/interior.jpg", alt: "The bar at McGuire's Irish Pub, with signed dollar bills covering the ceiling and walls and a Sl\u00e1inte stained glass sign" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/drink-root-beer.jpg", alt: "Sam's drink: a glass of McGuire's house root beer with a thick foam head, McGuire's Irish Pub" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/order-bread.jpg", alt: "A dark loaf of bread with melted butter poured over it on a wooden board, McGuire's Irish Pub" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/order-senate-bean-soup.jpg", alt: "Sam's order: a bowl of the 18 cent Senate Bean Soup with carrots and parsley, McGuire's Irish Pub" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/order-reuben-egg-rolls.jpg", alt: "Sam's order: Reuben Egg Rolls sliced open around a cup of dipping sauce, McGuire's Irish Pub" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/order-filet-mignon.jpg", alt: "Sam's order: a grilled Filet Mignon on a cast iron plate with a medium rare marker and an Irish flag in the potatoes, McGuire's Irish Pub" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/order-pasta-rustica.jpg", alt: "Sam's order: Pasta Rustica in cream sauce with sausage, bacon and tomatoes, with garlic bread, McGuire's Irish Pub" },
      { src: "images/reviews/mcguires-irish-pub-panama-city-beach/order-garlic-mashed-potatoes.jpg", alt: "Sam's order: Garlic Mashed Potatoes topped with chopped parsley, McGuire's Irish Pub" },
    ],
    // scores: { taste: 9, value: 9, atmosphere: 9, service: 8 }, // TODO: Sam — fill in your 0-10 breakdown and this section will appear automatically.
    pros: ["Great atmosphere"],
    cons: ["Busy"],
    rating: 8.8,
    video: "https://www.instagram.com/reel/DdZ7sp5x3wj/",
    tags: ["Irish", "Front Beach Road"],
  },
  {
