/* ============================================================
   ...
   cuisine, photos [{src, alt}], scores {taste,value,
...
const PLACES = [
  {
    ...
    // Dusty's has no real website of its own, so this points at their verified
    // Instagram, which the review page renders as "Instagram" instead of "Website".
    website: "https://www.instagram.com/dustyspcb/",
    date: "2026-09-04",
    price: "$$",
    cuisine: "Seafood",
    badges: ["worth-the-wait"],
    about: "Dusty's Oyster Bar is a Panama City Beach institution on Front Beach Road, a loud, packed oyster bar with dollar bills stapled across every inch of the ceiling. Their own slogan is \"Home of warm beer, lousy food and ugly waitresses,\" which tells you how seriously the place takes itself.",
    ate: "The Dusty's Oyster Sampler, a half dozen seafood oysters, the world famous fried green tomatoes, and frog legs.",
    heroPhoto: "images/reviews/dustys-oyster-bar-panama-city-beach/order-oyster-sampler.jpg",
    photos: [
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/storefront.jpg", alt: "Dusty's Oyster Bar & Eatery sign and entrance off the gravel lot, Panama City Beach" },
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/interior-bar.jpg", alt: "The packed bar at Dusty's Oyster Bar, with dollar bills stapled across the ceiling" },
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/interior.jpg", alt: "Dining room at Dusty's Oyster Bar, dollar bills covering the ceiling above the bar seating" },
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/order-oyster-sampler.jpg", alt: "Sam's order: the Dusty's Oyster Sampler, baked oysters with bacon, cheese, spinach and salsa toppings" },
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/order-seafood-oysters.jpg", alt: "Sam's order: a half dozen seafood oysters baked with crab, shrimp and parmesan, Dusty's Oyster Bar" },
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/order-fried-green-tomatoes.jpg", alt: "Sam's order: the world famous fried green tomatoes with ranch, Dusty's Oyster Bar" },
      { src: "images/reviews/dustys-oyster-bar-panama-city-beach/order-frog-legs.jpg", alt: "Sam's order: fried frog legs with honey mustard, Dusty's Oyster Bar Panama City Beach" },
    ],
    // scores: { taste: 8, value: 8, atmosphere: 9, service: 7 }, // TODO: Sam — fill in your 0-10 breakdown and this section will appear automatically.
    pros: ["Cool environment"],
    cons: ["Busy"],
    rating: 8.1,
    video: "https://www.instagram.com/reel/DdH2iTFxg3J/",
  ...
  },
  {
    ...
    photos: [
      { src: "images/reviews/pelato-nashville/storefront.jpg", alt: "Pelato storefront sign, Germantown, Nashville" },
      { src: "images/reviews/pelato-nashville/interior.jpg", alt: "Inside Pelato, bar and dining room, Nashville" },
      { src: "images/reviews/pelato-nashville/order-mozzarella.jpg", alt: "Sam's order: Mozzarella Caprese, Pelato" },
      { src: "images/reviews/pelato-nashville/order-radiatori-vodka.jpg", alt: "Sam's order: Radiatori Vodka, Pelato" },
      { src: "images/reviews/pelato-nashville/order-chicken-parm.jpg", alt: "Sam's order: Chicken Parmigiana, Pelato" },
      { src: "images/reviews/pelato-nashville/order-campanelle.jpg", alt: "Sam's order: Campanelle Shrimp Limone, Pelato" },
    ],
    // scores: { taste: 8, value: 8, atmosphere: 6, service: 7 }, // TODO: Sam — fill in your 0-10 breakdown and this section will appear automatically.
  ...
  },
  {
    ...
    badges: ["favorite", "date-night", "best-drinks", "best-patio"],
  ...
  },
  {
    ...
    lat: 36.1391356,
    lng: -86.7626245,
    address: "1416 4th Ave S, Ste 114, Nashville, TN 37210",
    phone: "(615) 753-1090",
    parking: "Free and paid parking available",
    website: "https://marunashville.com/",
    date: "2026-08-06",
    price: "$$",
    cuisine: "Sushi",
    badges: ["favorite", "quick-bite", "date-night", "best-drinks"],
    about: "Maru is a Nashville-based sushi restaurant group with several locations across the city. This one sits in the Wedgewood-Houston (WeHo) neighborhood just south of downtown, in a sleek, industrial-style space with a full sushi bar, specialty rolls, and a cocktail menu.",
    ate: "The Pink Lady, Tiger, and Dynamite rolls.",
    heroPhoto: "images/reviews/maru-weho-nashville/order.jpg",
    photos: [
      { src: "images/reviews/maru-weho-nashville/storefront.jpg", alt: "Maru WeHo storefront sign, Wedgewood-Houston, Nashville" },
      { src: "images/reviews/maru-weho-nashville/interior.jpg", alt: "Inside Maru WeHo, dining room and sushi bar" },
      { src: "images/reviews/maru-weho-nashville/order.jpg", alt: "Sam's order: Pink Lady, Tiger, and Dynamite rolls, Maru WeHo" },
    ],
    // scores: { taste: 8, value: 8, atmosphere: 6, service: 7 }, // TODO: Sam — fill in your 0-10 breakdown and this section will appear automatically.
    pros: ["Cool bar", "Free and paid parking available", "Super quick", "Great date night or business meeting spot"],
    rating: 9.2,
    video: "https://www.instagram.com/reel/Db1fTl8RuLg/",
    tags: ["Sushi", "Wedgewood-Houston"],
  },
  {
    id: "daddys-dogs-nashville",
    name: "Daddy's Dogs",
    city: "Nashville, TN",
    lat: 36.1641775,
    lng: -86.8524284,
    address: "5205 Centennial Blvd, Nashville, TN 37209",
    phone: "(615) 802-8481",
    parking: "Free parking nearby",
    website: "https://www.daddysdogs.com/the-nations",
    date: "2026-08-05",
    price: "$$",
    cuisine: "Hot Dogs",
    badges: ["quick-bite", "family-friendly", "easy-parking", "best-patio", "hidden-gem"],
    about: "Daddy's Dogs started as a Nashville street cart in 2015 before growing into several brick-and-mortar locations around the city. This location, in The Nations, is set inside a converted gas station painted bright yellow, with a covered patio, cornhole, and a menu built entirely around specialty hot dogs and hand-spun shakes.",
    ate: "The Mac Daddy and the Big Daddy.",
    heroPhoto: "images/reviews/daddys-dogs-nashville/order.jpg",
    photos: [
      { src: "images/reviews/daddys-dogs-nashville/storefront.jpg", alt: "Ordering at the walk-up window, Daddy's Dogs, The Nations, Nashville" },
      { src: "images/reviews/daddys-dogs-nashville/patio.jpg", alt: "Covered patio and picnic tables at Daddy's Dogs, Nashville" },
      { src: "images/reviews/daddys-dogs-nashville/order.jpg", alt: "Sam's order: the Mac Daddy and the Big Daddy hot dogs, Daddy's Dogs" },
    ],
    // scores: { taste: 8, value: 8, atmosphere: 6, service: 7 }, // TODO: Sam — fill in your 0-10 breakdown and this section will appear automatically.
    pros: ["Free parking", "Quick", "Family friendly", "Great patio"],
    cons: ["Super messy"],
    rating: 8.5,
    video: "https://www.instagram.com/reel/DbwHRL2sp4k/",
    tags: ["Hot Dogs", "The Nations"],
  },
  {
